...
public class catalogoClientesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicializarArrays();
        guardarDatosEnArray();
        customAdapter = new CustomAdapter2(catalogoClientesActivity.this,this, nombre_pr, referencia_pr, marca_pr,
                descr_pr,id_producto, id_seccionPr,precio_pr,idCarrito);
        recProductos.setAdapter(customAdapter);
        recProductos.setLayoutManager(new LinearLayoutManager(catalogoClientesActivity.this));
